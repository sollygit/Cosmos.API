...
namespace Cosmos.Api.Services
{
    ...
    public class BlobStorageService : IStorageService
    {
        ...
        public BlobStorageService(IOptions<StorageOptions> config)
        {
            _options = config.Value;
            _account = CloudStorageAccount.Parse(_options.ConnectionString);
            _client = _account.CreateCloudBlobClient();
            _container = _client.GetContainerReference(_options.ContainerName);
        }
